...
public class PropertyInfo extends AbstractMemberInfo
{
	...
	public function PropertyInfo(name:String, isStatic:Boolean, type:Class, declaringType:Class, reflectedType:Class, read:Boolean, write:Boolean, metadataCount:int)
	{
